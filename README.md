...
- **📑기획서(PPT 발표 자료)**: [Figma Slides](https://www.figma.com/deck/fW4DByiNGLEvzvNIbLSPP1/2%EC%B0%A8-CGV-%EB%A6%AC%EB%89%B4%EC%96%BC-PPT?node-id=1-1735&t=yzutuAnjAqo0JM4h-1) 
- **🔗GitHub:** [CGV Renewal](https://github.com/kyt0830/Renewal_project_Cgv)  
...
CGV 사이트 리뉴얼 프로젝트입니다.  
**PHP**와 **MySQL**을 **백엔드**로 사용하며, **프론트엔드**는 **HTML**, **CSS**, **JavaScript**(**jQuery** 포함)로 구현했습니다.  
